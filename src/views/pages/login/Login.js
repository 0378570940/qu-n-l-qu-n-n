...
const Login = (props) => {
  ...
  const serveLogin = async () => {
    ...
    if (response.status === 401) {
      ...
      navigate("/views/Quanlyquanan/QuanAn")
    }
  }
                ...
                <CCardBody>
                  <CForm>
                    ...
                    <CInputGroup className="mb-3">
                      ...
                      <CFormInput placeholder="Username" name='username' onChange={ChangeValue} autoComplete="username" />
                    </CInputGroup>
                    ...
                    <CRow>
                      <CCol xs={6}>
                        <CButton color="primary" className="px-4" onClick={serveLogin}>
                          Login
                        </CButton>
                      </CCol>
